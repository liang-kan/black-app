<template>
  <view class="add-tv-container">
    <!-- 顶部导航 -->
    <view class="header">
      <view class="header-left" @click="handleBack">
        <uni-icons type="left" size="24"></uni-icons>
      </view>
      <view class="header-title">新增电视</view>
    ...
    <view class="form-section">
      ...
      <view class="form-item">
        <text class="form-label">屏幕尺寸(英寸)</text>
        <uni-easyinput v-model="form.screenSize" type="number" placeholder="请输入屏幕尺寸" class="form-input"></uni-easyinput>
      </view>
      ...
      <view class="form-item">
        ...
        <uni-easyinput v-model="form.resolution" placeholder="请输入分辨率" class="form-input"></uni-easyinput>
      </view>
      
      <view class="form-item">
        <text class="form-label">全面屏标志</text>
        <uni-data-select 
          v-model="form.haveFrame" 
          :localdata="haveFrameOptions" 
          placeholder="请选择"
          class="form-select"
        ></uni-data-select>
      </view>
      ...
      <view class="form-item">
        <text class="form-label">面板类型</text>
        <uni-easyinput v-model="form.panelType" placeholder="请输入面板类型" class="form-input"></uni-easyinput>
      </view>
      
      <view class="form-item">
        <text class="form-label">接口信息</text>
        <uni-easyinput v-model="form.portInfo" placeholder="请输入接口信息" class="form-input"></uni-easyinput>
      </view>
      
      <view class="form-item">
        <text class="form-label">能否上网</text>
        <uni-data-select 
          v-model="form.isInternet" 
          :localdata="internetOptions" 
          placeholder="请选择"
          class="form-select"
        ></uni-data-select>
      </view>
      ...
      <view class="form-item">
        <text class="form-label">瑕疵点</text>
        <uni-easyinput v-model="form.flaw" placeholder="请输入瑕疵点" class="form-input"></uni-easyinput>
      </view>
      
      <view class="form-item">
        <text class="form-label">能效等级</text>
        <uni-easyinput v-model="form.energyRating" placeholder="请输入能效等级" class="form-input"></uni-easyinput>
      </view>
...
<script>
import { addTvs } from '@/api/system/tvs';
