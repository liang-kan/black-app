<template>
  <view class="add-stand-container">
    <!-- 顶部导航 -->
    <view class="header">
      <view class="header-left" @click="handleBack">
        <uni-icons type="left" size="24"></uni-icons>
      </view>
      <view class="header-title">新增脚架</view>
    ...
    <view class="form-section">
      ...
      <view class="form-item">
        ...
        <uni-easyinput v-model="form.mountType" placeholder="请输入类型" class="form-input"></uni-easyinput>
      </view>
      
      <view class="form-item">
        <text class="form-label">最大承重(KG)</text>
        <uni-easyinput v-model="form.maxLoadKg" type="number" placeholder="请输入最大承重" class="form-input"></uni-easyinput>
      </view>
      
      <view class="form-item">
        <text class="form-label">适用尺寸范围</text>
        <uni-easyinput v-model="form.fitsSizeRange" placeholder="请输入适用尺寸范围" class="form-input"></uni-easyinput>
      </view>
      
      <view class="form-item">
        <text class="form-label">VESA孔距</text>
        <uni-easyinput v-model="form.vesaStandard" placeholder="请输入VESA孔距" class="form-input"></uni-easyinput>
      </view>
      
      <view class="form-item">
        <text class="form-label">钢材厚度</text>
        <uni-easyinput v-model="form.steelThickness" type="number" placeholder="请输入钢材厚度" class="form-input"></uni-easyinput>
      </view>
...
<script>
import { addMounts } from '@/api/system/mounts';
...
.form-select:focus {
  ...
  box-shadow: 0 0 10rpx rgba(240, 147, 251, 0.3);
...
.submit-btn {
  ...
  font-weight: bold;
  text-align: center;
  box-shadow: 0 5rpx 15rpx rgba(240, 147, 251, 0.4);
  transition: all 0.3s ease;
}
